...
CREATE TABLE "app"."usage_events" (
	...
	CONSTRAINT "usage_events_ingest_hash_format" CHECK ("app"."usage_events"."ingest_hash" ~ '^[0-9a-f]{64}$'),
...
--> statement-breakpoint
ALTER TABLE "app"."ingest_rejections" ADD CONSTRAINT "ingest_rejections_source_id_ingest_sources_id_fk" FOREIGN KEY ("source_id") REFERENCES "app"."ingest_sources"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "app"."usage_events" ADD CONSTRAINT "usage_events_source_id_ingest_sources_id_fk" FOREIGN KEY ("source_id") REFERENCES "app"."ingest_sources"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
